...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: tr
      ? "Scores TV oyunları: Bil Kazan düellolarında tahmin yap, Scores Puanı topla, liderlik tablosunda yüksel. Kadronu Kur ve Haftanın Oyuncusu çok yakında!"
      : "Scores TV games: make predictions in Predict & Win duels, collect Scores Points and climb the leaderboard. Build Your XI and Player of the Week coming soon!",
    alternates: {
      canonical: "/oyunlar",
