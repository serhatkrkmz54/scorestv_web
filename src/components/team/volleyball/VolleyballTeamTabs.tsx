...
export type VlTeamTabKey = "overview" | "fixtures";

export interface VlTeamTabDef {
  key: VlTeamTabKey;
  label: string;
  icon?: ReactNode;
}
...
interface Props {
  tabs: VlTeamTabDef[];
  active: VlTeamTabKey;
  onChange: (k: VlTeamTabKey) => void;
}

// Voleybol takim sekme seridi — basketbol TeamTabs ile ayni CSS.
export function VolleyballTeamTabs({ tabs, active, onChange }: Props) {
