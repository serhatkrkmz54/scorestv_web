...
export type BkTeamTabKey = "overview" | "squad" | "fixtures" | "stats";

export interface BkTeamTabDef {
  key: BkTeamTabKey;
  label: string;
  icon?: ReactNode;
}
...
interface Props {
  tabs: BkTeamTabDef[];
  active: BkTeamTabKey;
  onChange: (k: BkTeamTabKey) => void;
}

// Basketbol takim sekme seridi — futbol TeamTabs ile ayni CSS.
export function BasketballTeamTabs({ tabs, active, onChange }: Props) {
