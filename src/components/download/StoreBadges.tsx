...
// Sunucu + istemci uyumlu (yalnızca <a> + SVG; hook yok). App Store ve Google
// Play rozetleri — koyu pill, beyaz marka logosu. Marka ikonları simple-icons
// (CC0). Rozet üzerindeki metin standart İngilizce (mağaza yönergeleri).
...
/** İkisi bir arada — indirme landing'i ve footer için. */
