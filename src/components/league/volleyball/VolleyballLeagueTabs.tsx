...
export type VlLeagueTabKey = "standings" | "fixtures";

export interface VlLeagueTabDef {
  key: VlLeagueTabKey;
  label: string;
  icon?: ReactNode;
}
...
interface Props {
  tabs: VlLeagueTabDef[];
  active: VlLeagueTabKey;
  onChange: (k: VlLeagueTabKey) => void;
}

// Voleybol lig sekme seridi — basketbol LeagueTabs ile ayni CSS.
export function VolleyballLeagueTabs({ tabs, active, onChange }: Props) {
