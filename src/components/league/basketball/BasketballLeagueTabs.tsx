...
export type BkLeagueTabKey = "standings" | "fixtures";

export interface BkLeagueTabDef {
  key: BkLeagueTabKey;
  label: string;
  icon?: ReactNode;
}
...
interface Props {
  tabs: BkLeagueTabDef[];
  active: BkLeagueTabKey;
  onChange: (k: BkLeagueTabKey) => void;
}

// Basketbol lig sekme seridi — futbol LeagueTabs ile ayni CSS.
export function BasketballLeagueTabs({ tabs, active, onChange }: Props) {
